...
void FieldLJ::freeMemory()
{

}

void FieldLJ::allocateMemory()
{
	Ex.resize(N_width);
	Ey.resize(N_width);
...
void FieldLJ::setNM(int N, int M)
{
	N_width = N;
	M_depth = M;
}

void FieldLJ::getNM(int & N, int & M) const
{
	N = N_width;
	M = M_depth;
}

void FieldLJ::setPlane(const GraphTrans & _graphTransPara, double _ds)
{
...
void FieldLJ::setField(complex<double>** _Ex, complex<double>** _Ey,
...
void FieldLJ::setField(const vector<vector<complex<double>>>& _Ex, 
...
const vector<vector<complex<double>>>& FieldLJ::getEx() const
{
	return Ex;
}

const vector<vector<complex<double>>>& FieldLJ::getEy() const
{
	return Ey;
}

void FieldLJ::setDs(double _Ds)
{
	ds = _Ds;
}

double FieldLJ::getDs() const
{
	return ds;
}

void FieldLJ::getSourcePara(GraphTrans & _graphTransPara,
...
void FieldLJ::setShowPara(int _content, bool _isLinear, bool _isPhs)
{
	content = _content;
	isLinear = _isLinear;
	isPhs = _isPhs;
...
void FieldLJ::getShowPara(int & _content, bool & _isLinear, bool & _isPhs)
{
	_content = content;
	_isLinear = isLinear;
	_isPhs = isPhs;
...
void FieldLJ::set3D(bool _is3D)
{
	is3D = _is3D;
}

bool FieldLJ::get3D() const
{
	return is3D;
}

void FieldLJ::calActor3D()
{
...
vtkSmartPointer<vtkImageActor> FieldLJ::getActor() const
{
	return actor;
}

vtkSmartPointer<vtkActor> FieldLJ::getActor3D() const
{
	return actor3D;
}

void FieldLJ::save(const std::string & fileName) const
{
	if (isSource)
	{
...
void FieldLJ::setIsShow(bool ok)
{
	//isShow = ok;
	if (!ok)
	{
...
void FieldLJ::setIsSource(bool isOK)
{
	isSource = isOK;
}

void FieldLJ::readData(const string & fileAddress)
{
